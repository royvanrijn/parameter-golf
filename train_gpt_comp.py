...
def main() -> None:
    ...
    quant_comp_blob = zlib.compress(quant_comp_raw, level=9)
    ...
    quant_comp_state = torch.load(io.BytesIO(zlib.decompress(quant_comp_blob_disk)), map_location="cpu")
    ...
    if QUANT_BENCHMARK:
        ...
        for method_name in method_names:
            ...
            bench_state = torch.load(io.BytesIO(zlib.decompress(bench_blob)), map_location="cpu")
